  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="unemployedempl" id="unemployed" /> <label htmlFor="unemployed">Unemployed</label>
            <br />

            <input type="radio" name="part-timeempl" id="part-time" /> <label htmlFor="part-time">Part-time</label>
            <br />

            <input type="radio" name="full-timeempl" id="full-time" /> <label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
