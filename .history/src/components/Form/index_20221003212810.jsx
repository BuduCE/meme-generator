  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="employment" id="part-time" value="part-time" /><label htmlFor="part-time">Part-time</label>
            <br />

            <input type="radio" name="employment" id="full-time" value="full-time" /><label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
