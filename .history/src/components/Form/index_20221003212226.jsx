  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="unemployed" id="unemployed" /> <label htmlFor="unemployed">Unemployed</label>
            <br />

            <input type="radio" name="part-time" id="part-time" /> <label htmlFor="part-time">Part-time</label>
            <br />

            <input type="radio" name="full-time" id="full-time" /> <label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
