  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="unemployedemployment" id="unemployed" /> <label htmlFor="unemployed">Unemployed</label>
            <br />

            <input type="radio" name="part-timeemployment" id="part-time" /> <label htmlFor="part-time">Part-time</label>
            <br />

            <input type="radio" name="full-timeemployment" id="full-time" /> <label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
