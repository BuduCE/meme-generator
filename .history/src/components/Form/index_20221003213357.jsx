  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="employment" id="part-time" value="part-time" onChange={handleChange} checked={data.employment === "unemployed"/><label htmlFor="part-time">Part-time</label>
            <br />
