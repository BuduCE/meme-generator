  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="employment" id="full-time" value="full-time" onChange={handleChange} checked={data.employment === "part-time"}/><label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
