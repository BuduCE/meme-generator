  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="unemployedemploymwnt" id="unemployed" /> <label htmlFor="unemployed">Unemployed</label>
            <br />

            <input type="radio" name="part-timeemploymwnt" id="part-time" /> <label htmlFor="part-time">Part-time</label>
            <br />

            <input type="radio" name="full-timeemploymwnt" id="full-time" /> <label htmlFor="full-time">Full-time</label>
        </fieldset>
    </form>
  )
}
