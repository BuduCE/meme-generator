  ...
  return (
    <form>
        ...
        <fieldset>
            ...
            <input type="radio" name="employment" id="unemployed" value={unemployment} /> <label htmlFor="unemployed">Unemployed</label>
            <br />

            <input type="radio" name="employment" id="part-time" /> <label htmlFor="part-time">Part-time</label>
            <br />
