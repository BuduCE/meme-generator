...
const Meme = () => {
  ...
  return (
    <main>
      <div className='form'>
          <input type="text" placeholder='Shut up' name='top-text' className='meme-input'/>

          <input type="text" placeholder='and take my money' name='bottom-text' value={} className='meme-input'/>
