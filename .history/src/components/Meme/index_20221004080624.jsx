...
const Meme = () => {
  ...
  return (
    <main>
      <div className='form'>
          <input type="text" placeholder='Shut up' name='topText' className='meme-input'/>

          <input type="text" placeholder='and take my money' name='bottomText' value={meme.bottom} className='meme-input'/>
