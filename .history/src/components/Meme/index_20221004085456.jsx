...
const Meme = () => {
  ...
  return (
    <main>
      <div className='form'>
          <input type="text" placeholder='Shut up' name='topText' value={meme.topText}className='meme-input' onChange={hn}/>

          <input type="text" placeholder='and take my money' name='bottomText' value={meme.bottomText} className='meme-input' onChange={hn}/>
