...
const Meme = () => {
  ...
  return (
    <main>
      <div className='form'>
          <input type="text" placeholder='Shut up' name='topText' value={meme.topText}className='meme-input' onChange={displayImg}/>

          <input type="text" placeholder='and take my money' name='bottomText' value={meme.bottomText} className='meme-input' onChange={handleChange}/>

          <button className='meme-btn' onClick={handleChange}>Get a new meme image</button>
      </div>

      <div className='meme'>
          <img src={meme.randomImg} alt="" className='meme-img' name="randomImg" value={meme.randomImg}/>
